...
const Container = tw.div`relative bg-blue-600 text-gray-100 -mb-8 -mx-8 px-8 py-20 lg:py-24`;
...
const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`absolute top-0 left-0 w-80 h-80 transform -translate-x-20 -translate-y-32 text-black opacity-25`;
const DecoratorBlob2 = tw(
  SvgDecoratorBlob1
)`absolute bottom-0 right-0 w-80 h-80 transform  translate-x-32 translate-y-48 text-secondary-900 opacity-25`;
      ...
      <Content>
        ...
        <ThreeColRow>
          <LogoContainer>
            ...
            <LogoText>ShortNt</LogoText>
          </LogoContainer>
          <CopywrightNotice>&copy; 2021 ShortNt All Rights Reserved.</CopywrightNotice>
