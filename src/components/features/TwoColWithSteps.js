...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-blue-600">Professionals.</span>
    </>
  ),
    ...
    <Container>
      <TwoColumn>
        <ImageColumn>
          ...
          <Image className="mymove" src={TeamIllustrationSrc} />
          {imageDecoratorBlob && <DecoratorBlob css={decoratorBlobCss} />}
        </ImageColumn>
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            <Subheading>STEPS</Subheading>
            <Heading><h2>Easy to <span tw="text-blue-600">Get Started</span></h2></Heading>
            <Steps>
